...
*/
 get_header(); ?>
<div style="background-image: linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url('<?php echo get_the_post_thumbnail_url() ?>)'" class="header-img d-flex flex-center">
    ...
    <div class="container title-container">
        ...
        <?php if (get_field('personal_advice')) : ?>
            <div class="personal-advice">
                ...
                <p>Maak een afspraak voor een gratis adviesgesprek met één van onze experts.</p>
